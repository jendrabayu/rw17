$(document).ready(function () {
  ...
  $.getJSON(endPoint, function (response) {
    ...
    let chart_jenis_kelamin = Highcharts.chart('chart-jenis-kelamin', pie);
    chart_jenis_kelamin.title.textSetter("Grafik Jenis Kelamin");
    chart_jenis_kelamin.series[0].setData(response.jenisKelamin);

    let chart_jenis_kelamin_bar = Highcharts.chart('chart-jenis-kelamin-bar', column);
    chart_jenis_kelamin_bar.title.textSetter("Grafik Jenis Kelamin");
    chart_jenis_kelamin_bar.series[0].setData(response.jenisKelamin);
    ...
    let chart_hubungan_dalam_keluarga = Highcharts.chart('chart-hubungan-dalam-keluarga', pie);
    chart_hubungan_dalam_keluarga.title.textSetter("Grafik Hubungan Dalam Keluarga");
    chart_hubungan_dalam_keluarga.series[0].setData(response.hubunganDalamKeluarga);

    let chart_hubungan_dalam_keluarga_bar = Highcharts.chart('chart-hubungan-dalam-keluarga-bar', column);
    chart_hubungan_dalam_keluarga_bar.title.textSetter("Grafik Hubungan Dalam Keluarga");
    chart_hubungan_dalam_keluarga_bar.series[0].setData(response.hubunganDalamKeluarga);
